...
- title: Optimized
  details: Bricks is a fast and optimized theme. On the web, performance is not an option, and Bricks is developed by taking into account every reasonable way to improve its speed and SEO compatibility.
- title: Documented
